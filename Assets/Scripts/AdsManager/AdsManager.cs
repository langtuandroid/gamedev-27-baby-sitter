...
namespace AdsManager
{
	public class AdsManager : MonoBehaviour {
		...
		public static AdsManager Instance
		{
			...
			{
				if(_instance == null)
					_instance = GameObject.FindObjectOfType(typeof(AdsManager)) as AdsManager;
		...
		public void ShowVideoReward()
		{
			...
			//else
			{
				GameObject.Find("Canvas").GetComponent<MenuManager>().ShowPopUpMessage("VIDEO NOT READY", "PLEASE TRY AGAIN LATER");
			}
		}
